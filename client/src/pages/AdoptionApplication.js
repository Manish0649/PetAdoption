...
const AdoptionApplication = () => {
  ...
  // ✅ Pet details (query params ya state se pick karna)
  const pet = location.state?.pet || {};

  const petDetails = {
    petId: params.get("petId") || pet.id || null,
    petName: params.get("petName") || pet.petName || "Unknown Pet",  // ✅ FIX
    age: params.get("age") || pet.age || "N/A",
    area: params.get("area") || pet.area || "N/A",
    petType: params.get("petType") || pet.petType || "Unknown",     // ✅ FIX
    email: params.get("email") || pet.email || "",
    phone: params.get("phone") || pet.phone || "",
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const applicationData = {
      ...formData,
      ...petDetails, // ✅ Pet info backend ko bhejna
    };
