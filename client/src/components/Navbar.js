  ...
  return (
    <nav className="navbar-container">
      ...
      <div className="navbar">
        ...
        <NavLink to="/review" className={({ isActive }) => isActive ? "navbar-item active" : "navbar-item"}>Review</NavLink>
      </div>
        ...
        {!isLoggedIn ? (
          ...
          <div className="profile-dropdown">
            ...
            <div className="dropdown-content">
              {role === "admin" && (
                <>
                  <Link to="/pending-applications">Pending Applications</Link> 
              ...
              {role === "user" && (
                <>
                  ...
                  <NavLink to="/my-pets" className="nav-link">My Pets</NavLink>
                </>
              )}
